    ...
    public:
        ...
        */
        ...
        struct link_data {
            ...
            tripoint_abs_ms t_abs_pos = tripoint_abs_ms::min;
            ...
            tripoint_bub_ms s_bub_pos = tripoint_bub_ms::min; // NOLINT(cata-serialize)
        ...
        */
        ...
        std::string type_name( unsigned int quantity = 1, bool use_variant = true,
                               bool use_cond_name = true, bool use_corpse = true , bool use_skillbased_names = true) const;
        ...
        */
         ...
         */
        body_part_set get_covered_body_parts( const Character *you = nullptr ) const;
        /**
        ...
        */
         ...
         */
        std::vector<sub_bodypart_id> get_covered_sub_body_parts( const Character *you = nullptr ) const;
